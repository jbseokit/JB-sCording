...
import ieetu.common.config.etc.EgovComTraceHandler;
import ieetu.common.config.etc.EgovMessageSource;
import ieetu.common.config.etc.EgovMultipartResolver;
import ieetu.common.config.etc.ImagePaginationRenderer;
 ...
 */
@Configuration
@ComponentScan(basePackages = "ieetu", includeFilters = {
