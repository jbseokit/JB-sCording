...
import ieetu.common.interceptor.AuthenticInterceptor;
import ieetu.common.interceptor.CustomAuthenticInterceptor;
 ...
 */
@Configuration
@ComponentScan(basePackages = "ieetu", excludeFilters = {
